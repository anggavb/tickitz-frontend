          ...
          <div>
            ...
            <div className="relative mt-2">
              <input
                ...
                className={`w-full border rounded-xl px-4 py-3 pr-12 disabled:bg-slate-50 ${errors.password ? 'border-red-500' : ''}`}
                {...register('password', {
          ...
          <div>
            ...
            <div className="relative mt-2">
              <input
                ...
                className={`w-full border rounded-xl px-4 py-3 pr-12 disabled:bg-slate-50 ${errors.confirmPassword ? 'border-red-500' : ''}`}
