      ...
      <main className="min-h-screentext-gray-900 ">
        ...
        <article className="mx-auto flex max-w-7xl items-center gap-10 py-12">
          <section className="w-7/10 space-y-5">
            <p className="text-sm font-semibold uppercase tracking-widest text-primary">Movie Ticket Purchases #1 in Indonesia</p>

            <h1 className="max-w-5xl text-6xl font-bold leading-tight">Experience the Magic of Cinema: Book Your Tickets Today</h1>

            <p className="max-w-xl text-lg text-gray-600">Sign up and get the ticket with a lot of discount</p>
          </section>
          <section className="grid w-3/10 grid-cols-2 gap-5">
            <div className="flex flex-col gap-3">
              <img src={movie} alt="Movie poster" className="h-40 w-full rounded-t-2xl object-cover object-top" />
              <img src={movie} alt="Movie poster" className="h-64 w-full rounded-b-2xl object-cover" />
            </div>

            <div className="flex flex-col gap-3">
              <img src={movie} alt="Movie poster" className="h-64 w-full rounded-t-2xl object-cover" />

              <img src={movie} alt="Movie poster" className="h-40 w-full rounded-b-2xl object-cover object-top" />
            </div>
          </section>
        </article>
        {/* Why Choose Us */}
        <article className="mx-auto max-w-7xl py-8">
          <p className="mb-8 text-sm font-semibold uppercase tracking-widest text-primary">Why Choose Us</p>
          <h2 className="mb-12 max-w-2xl text-4xl font-bold leading-tight text-neutral-900 md:text-5xl">Unleashing the Ultimate Movie Experience</h2>
          <section className="grid gap-6 md:grid-cols-3">
            <div className=" p-6 shadow-sm">
              <img src={movie} alt="Guaranteed Icon" className="mb-5 h-16 w-16 rounded-full object-cover" />
            ...
            <div className=" p-6 shadow-sm">
              <img src={movie} alt="Affordable Icon" className="mb-5 h-16 w-16 rounded-full object-cover" />
            ...
            <div className=" p-6 shadow-sm">
              <img src={movie} alt="Customer Support Icon" className="mb-5 h-16 w-16 rounded-full object-cover" />
        ...
        <article className="mx-auto max-w-7xl py-8">
          <div className="text-center">
            <p className="mb-8 text-sm font-semibold uppercase tracking-widest text-primary">Movie</p>
            ...
            {[
              ...
              <div key={item.id} className="group relative flex flex-col">
                  ...
                  {item.recommended && (
                    <div className="absolute -left-2 top-2 z-20">
                      <div className="relative">
                        <div className="rounded-r-full bg-primary px-3 py-1 pr-5 text-xs font-semibold tracking-wide text-white">Recommended</div>

                        <div className="h-0 w-0 border-l-8 border-t-11 border-l-transparent border-t-primary" />
                      </div>
                    </div>
                  )}{' '}
                  <img src={movie} alt={item.title} className="h-full w-full object-cover" />
                  {/* Dark Overlay */}
                ...
                <div className="mt-4 flex flex-col gap-2">
                  <h3 className="text-xl font-bold text-neutral-900 transition-colors group-hover:text-primary">{item.title}</h3>
          ...
          <p className="mt-12 text-center font-semibold text-primary cursor-pointer hover:underline">View All &rarr;</p>
        </article>
        {/* Upcoming Movies (Terupdate Menggunakan Rasio Poster Film) */}
        <article className="mx-auto max-w-7xl py-8">
          <p className="mb-8 text-sm font-semibold uppercase tracking-widest text-primary">UPCOMING MOVIES</p>
          <h2 className="mb-12 max-w-2xl text-4xl font-bold leading-tight text-neutral-900 md:text-5xl">Exciting Movie Coming Soon</h2>
          <section className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
            {[
              {
                id: 1,
              ...
              <div key={item.id} className="group relative flex flex-col">
                ...
                <div className="mt-4 flex flex-col gap-2">
                  <h3 className="text-xl font-bold text-neutral-900 transition-colors group-hover:text-primary">{item.title}</h3>
                  <div className="flex flex-wrap gap-2 text-primary">December 2024</div>
                  <div className="flex flex-wrap gap-2">
                    {item.genres.map((genre) => (
                      <span
                        key={genre}
        ...
        <article className="relative mx-auto max-w-7xl overflow-hidden rounded-4xl bg-primary px-6 py-16 text-center md:px-12 md:py-20">
          ...
          <h2 className="relative z-10 text-2xl font-light tracking-wide text-white md:text-3xl lg:text-4xl">Subscribe to our newsletter</h2>
          <form className="relative z-10 mx-auto mt-6 max-w-3xl">
            <div className="grid gap-3 md:grid-cols-[1fr_1fr_0.8fr]">
              ...
              />
              <button className="h-12 rounded-lg bg-white px-4 text-base font-bold text-primary transition hover:bg-gray-100" type="submit">
                Subscribe Now
              </button>
            </div>
          </form>{' '}
