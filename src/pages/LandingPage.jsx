...
function LandingPage() {
  ...
  const upcomingMovies = [
    ...
    },
    {
      ...
      date: 'March 2027',
      genre: 'Action, Adventure',
      poster: 'https://upload.wikimedia.org/wikipedia/commons/6/60/Spiderman.JPG',
    },
    {
      id: 5,
      title: 'Spiderman 2',
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <section className="min-h-screen overflow-hidden bg-white text-neutral-900">
        ...
        <MovieSection label="Movie" title="Exciting Movies That Should Be Watched Today" movies={movies} />

        <UpcomingMovieSection label="Upcoming Movies" title="Exciting Movie Coming Soon" movies={upcomingMovies} />
      </section>
